...
- Since intrinsic _inputs_ are passed natively, we'd love intrinsic _outputs_ to be returned natively. In case of `.parse`, the signature would be `delim interp -- buf len err`, where `interp` is passed implicitly.
