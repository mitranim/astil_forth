...
echo
hyperfine $OPTS                                                  \
  --command-name baseline_our    './astil.exe   forth/lang.af'   \
  --command-name baseline_our_s  './astil_s.exe forth/lang_s.af' \
...
echo
hyperfine $OPTS                                                  \
  --command-name bubble_our    './astil.exe   bench/bubble.af'   \
  --command-name bubble_our_s  './astil_s.exe bench/bubble_s.af' \
...
echo
hyperfine $OPTS                                                \
  --command-name sieve_our    './astil.exe   bench/sieve.af'   \
  --command-name sieve_our_s  './astil_s.exe bench/sieve_s.af' \
...
hyperfine $OPTS                                                      \
  ...
  --command-name fib_loop_our    './astil.exe   bench/fib_loop.af'   \
  --command-name fib_loop_our_s  './astil_s.exe bench/fib_loop_s.af' \
...
hyperfine $OPTS                                                    \
  ...
  --command-name fib_rec_our    './astil.exe bench/fib_rec.af'     \
  --command-name fib_rec_our_s  './astil_s.exe bench/fib_rec_s.af' \
