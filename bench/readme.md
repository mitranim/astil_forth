...
Summary: in these _very limited_ microbenchmarks, the reg-CC implementation of Astil Forth trounces interpreters, and vaguely approaches Clang C with `-O2` (x1.5-x2).
