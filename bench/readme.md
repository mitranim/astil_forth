...
| `bin_tree_js_bun_lucky` | 401.3 ± 5.0 | 595.4 ± 19.1 | 198.9 ± 13.1 | 1.36 |
| `bin_tree_zig` | 418.0 ± 2.1 | 417.3 ± 2.1 | 25.9 ± 0.0 | 1.41 |
| `bin_tree_js_bun` | 1047.4 ± 3.1 | 1239.6 ± 8.0 | 182.8 ± 12.6 | 3.54 |
...
| --- | ---: | ---: | ---: | ---: | ---: |
| `cat_luajit_small` | 2.084 ± 0.093 | 621.2 ± 33.8 | 384.8 ± 34.4 | 1.541 ± 0.021 | 1.00 |
| `cat_global_small` | 2.132 ± 0.056 | 390.0 ± 22.3 | 371.2 ± 20.1 | 1.419 ± 0.026 | 1.02 |
| `cat_go_small` | 2.32 ± 0.99 | 1000.2 ± 438.1 | 828.2 ± 395.8 | 3.5 ± 0.0 | 1.11 |
| `cat_zig_small` | 2.32 ± 0.30 | 1070.6 ± 165.5 | 612.0 ± 52.0 | 1.900 ± 0.021 | 1.11 |
| `cat_astil_aot_small` | 2.55 ± 0.31 | 1391.0 ± 166.7 | 569.6 ± 87.3 | 1.231 ± 0.017 | 1.22 |
| `cat_gforth_small` | 3.08 ± 0.12 | 1486.0 ± 90.5 | 522.0 ± 46.4 | 2.109 ± 0.022 | 1.48 |
| `cat_clang_small` | 3.1 ± 1.4 | 900.4 ± 218.5 | 1149.4 ± 727.1 | 1.2 ± 0.0 | 1.49 |
| `cat_js_bun_small` | 10.13 ± 0.31 | 5869.4 ± 152.6 | 2636.4 ± 87.4 | 24.58 ± 0.12 | 4.86 |
| `cat_cl_sbcl_small` | 13.58 ± 0.51 | 4449.6 ± 30.8 | 7056.0 ± 372.8 | 39.663 ± 0.088 | 6.52 |
| `cat_pypy_small` | 15.40 ± 0.22 | 9496.0 ± 105.6 | 4240.8 ± 77.8 | 28.60 ± 0.10 | 7.39 |
| `cat_python_small` | 16.34 ± 0.25 | 11526.6 ± 209.1 | 2757.4 ± 56.1 | 11.61 ± 0.15 | 7.84 |
| `cat_astil_jit_small` | 27.10 ± 0.63 | 25711.2 ± 583.3 | 821.8 ± 64.5 | 2.831 ± 0.026 | 13.01 |
| `cat_java_small` | 42.35 ± 0.67 | 17095.8 ± 104.1 | 28493.4 ± 490.2 | 35.57 ± 0.14 | 20.33 |
| `cat_erlang_loop_small` | 72.16 ± 0.74 | 56898.0 ± 687.4 | 14851.0 ± 148.1 | 48.01 ± 0.36 | 34.63 |
...
| --- | ---: | ---: | ---: | ---: | ---: |
| `cat_zig_large` | 63.77 ± 0.71 | 2.514 ± 0.082 | 60.54 ± 0.64 | 1.941 ± 0.026 | 1.00 |
| `cat_astil_aot_large` | 67.18 ± 0.71 | 3.593 ± 0.058 | 62.90 ± 0.65 | 1.2 ± 0.0 | 1.05 |
| `cat_global_large` | 69.0 ± 1.2 | 3.205 ± 0.059 | 64.2 ± 1.1 | 1.400 ± 0.021 | 1.08 |
| `cat_clang_large` | 69.5 ± 1.0 | 5.51 ± 0.17 | 63.32 ± 0.91 | 1.216 ± 0.026 | 1.09 |
| `cat_gforth_large` | 71.73 ± 0.87 | 6.97 ± 0.25 | 63.38 ± 0.69 | 2.156 ± 0.029 | 1.12 |
| `cat_go_large` | 80.4 ± 1.7 | 8.60 ± 0.24 | 71.5 ± 1.5 | 3.597 ± 0.050 | 1.26 |
| `cat_cl_sbcl_large` | 82.7 ± 1.5 | 9.76 ± 0.27 | 70.4 ± 1.2 | 39.7 ± 0.0 | 1.30 |
| `cat_python_large` | 86.44 ± 0.65 | 19.70 ± 0.15 | 64.48 ± 0.66 | 11.606 ± 0.098 | 1.36 |
| `cat_astil_jit_large` | 91.7 ± 1.3 | 28.62 ± 0.33 | 62.4 ± 1.0 | 2.822 ± 0.021 | 1.44 |
| `cat_luajit_large` | 93.69 ± 0.69 | 29.52 ± 0.45 | 62.55 ± 0.35 | 1.916 ± 0.014 | 1.47 |
| `cat_pypy_large` | 96.2 ± 1.4 | 16.67 ± 0.16 | 77.3 ± 1.4 | 69.32 ± 0.25 | 1.51 |
| `cat_js_bun_large` | 101.76 ± 0.43 | 52.68 ± 0.30 | 67.52 ± 0.46 | 73.65 ± 0.14 | 1.60 |
| `cat_java_large` | 112.4 ± 1.1 | 66.67 ± 0.50 | 91.4 ± 1.1 | 42.87 ± 0.76 | 1.76 |
| `cat_erlang_loop_large` | 139.7 ± 1.6 | 69.67 ± 0.32 | 100.6 ± 1.1 | 50.77 ± 0.34 | 2.19 |
